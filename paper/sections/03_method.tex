...
% TODO: 0.25 page - state classical HRP in 5 lines
% Distance D_ij = sqrt(0.5 * (1 - rho_ij)), single-linkage clustering,
% quasi-diagonalization, recursive bisection with inverse-volatility weights.
