...
\usepackage[submission]{aaai2026}   % swap to aaai2027 when kit releases
\usepackage{times}
\usepackage{helvet}
\usepackage{courier}
...
% For camera-ready, replace with real name/affiliation/email.
...
significant); MCS at $\alpha=0.05$ cannot distinguish DHRP from the best
classical baseline. DHRP underperforms mean-variance in equity-heavy
universes where factor exposures dominate.
...
\appendix
% =====================================================================
% APPENDIX (unlimited pages, does NOT count toward 7-page body limit)
% =====================================================================
...
\begin{align}
\min_{\Pi}\ &\langle \Pi, C \rangle + \textstyle\sum_{i,\ell} \Pi_{i,\ell}\log \Pi_{i,\ell}, \notag\\
&\text{s.t.}\ \textstyle\sum_\ell \Pi_{i,\ell} = \mu_i\ \forall i,
\end{align}
...
\citep{Akhtar2024Croissant} following the MLCommons benchmark
documentation standard. The full JSON-LD is at
